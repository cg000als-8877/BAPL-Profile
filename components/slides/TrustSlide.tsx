    ...
    <AspectWrapper className="bg-slate-950 text-white">
      ...
      >
        ...
        <div className="relative z-10 my-auto">
          <div className="text-[10px] sm:text-xs md:text-sm font-bold text-slate-400 uppercase tracking-wider mb-2 flex items-center gap-2">
          ...
          >
            {/* BSCI */}
            <div className="p-2.5 sm:p-5 md:p-6 rounded-xl md:rounded-2xl bg-white text-slate-900 border border-slate-200 shadow-sm flex items-center gap-2 sm:gap-4">
              <div className="p-1.5 sm:p-3 rounded-lg md:rounded-xl bg-indigo-50 text-indigo-700 shrink-0">
              ...
              <div>
                ...
                <div className="text-[9px] sm:text-xs text-slate-500 hidden sm:block">
                  Social Compliance
                </div>
              </div>
            </div>
            ...
            {/* OEKO-TEX */}
            <div className="p-2.5 sm:p-5 md:p-6 rounded-xl md:rounded-2xl bg-white text-slate-900 border border-slate-200 shadow-sm flex items-center gap-2 sm:gap-4">
              <div className="p-1.5 sm:p-3 rounded-lg md:rounded-xl bg-emerald-50 text-emerald-700 shrink-0">
            ...
            {/* BGMEA & Fire Safety */}
            <div className="p-2.5 sm:p-5 md:p-6 rounded-xl md:rounded-2xl bg-white text-slate-900 border border-slate-200 shadow-sm flex items-center gap-2 sm:gap-4">
              <div className="p-1.5 sm:p-3 rounded-lg md:rounded-xl bg-amber-50 text-amber-700 shrink-0">
                <Building className="w-4 h-4 sm:w-7 sm:h-7" />
              </div>
              <div>
                <div className="text-xs sm:text-lg font-black text-slate-900 leading-tight">
                  BGMEA: 2673
        ...
        {/* Buyers Grid (4 cols on mobile, 8 cols on desktop) */}
        <div className="relative z-10 my-auto">
          <div className="text-[10px] sm:text-xs md:text-sm font-bold text-slate-400 uppercase tracking-wider mb-2 flex items-center justify-between">
          ...
          <div
            ref={buyersRef}
            className="grid grid-cols-4 lg:grid-cols-8 gap-1.5 sm:gap-3"
          >
            {buyers.map((b, i) => (
              <div
                key={i}
                className="group relative p-2 sm:p-3 md:p-4 rounded-xl md:rounded-2xl bg-white text-center border border-slate-200 shadow-sm hover:shadow-md transition-all flex flex-col items-center justify-center min-h-[44px] sm:min-h-[70px]"
              >
                <div className={`leading-tight ${b.color}`}>
                  {b.name}
                </div>
                <div className="text-[8px] sm:text-xs text-slate-500 font-medium truncate max-w-full hidden sm:block">
                  {b.sub}
                </div>
              </div>
            ))}
