...
export const HeroSlide: React.FC<SlideProps> = ({ isActive }) => {
  ...
  return (
    <AspectWrapper className="relative bg-[#060913] text-white overflow-hidden">
      {/* Full-Bleed Cinematic Background Image */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/baplprofile.webp"
          alt="Byzid Apparels Headquarters and Factory Facility"
          fill
          priority
          sizes="100vw"
          className="object-cover object-center brightness-75 contrast-105"
        />
        {/* Soft Vignette & Gradient Overlays for High Readability */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#060913] via-[#060913]/60 to-[#060913]/65" />
      ...
      >
        ...
        <div className="shrink-0 flex items-center justify-between">
          <div
            ref={badgeRef}
            className="inline-flex items-center gap-2 md:gap-3 px-3.5 md:px-5 py-1.5 md:py-2 rounded-full bg-slate-950/80 border border-[#69b23f]/50 backdrop-blur-md shadow-xl"
          >
            <span className="w-2 md:w-2.5 h-2 md:h-2.5 rounded-full bg-[#69b23f] animate-pulse" />
            <span className="text-[10px] sm:text-xs md:text-sm font-bold tracking-widest text-slate-100 uppercase">
              Corporate Profile
            </span>
          </div>

          <div className="flex items-center gap-1.5 md:gap-2 px-3.5 md:px-5 py-1.5 md:py-2 rounded-full bg-slate-950/80 border border-slate-700/80 backdrop-blur-md text-[10px] sm:text-xs md:text-sm text-slate-200 shadow-md">
        ...
        {/* Center: Main Hero Branding */}
        <div className="flex-1 flex flex-col justify-center my-auto py-2">
          <p
            ref={subtitleRef}
            className="text-xs sm:text-lg md:text-2xl lg:text-3xl font-semibold tracking-wider sm:tracking-widest text-[#88cb5c] uppercase mb-2 sm:mb-4 flex items-center gap-2 drop-shadow-md"
          >
          ...
          >
            <div className="flex items-center gap-2.5 md:gap-5">
              <span className="w-2.5 md:w-4 h-9 sm:h-16 md:h-24 lg:h-28 bg-[#69b23f] rounded-sm inline-block shadow-lg shadow-[#69b23f]/50" />
        ...
        >
          <div className="p-3 sm:p-4 md:p-6 rounded-xl md:rounded-2xl bg-slate-950/80 border border-slate-800/90 backdrop-blur-md flex items-center gap-3.5 hover:border-[#69b23f] transition-all shadow-lg">
            <div className="p-2.5 md:p-3.5 rounded-lg md:rounded-xl bg-[#69b23f]/25 text-[#88cb5c] shrink-0">
