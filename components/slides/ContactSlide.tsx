  ...
  return (
    <AspectWrapper className="bg-slate-50 text-slate-900">
      ...
      >
        ...
        {/* Split Screen Layout - Expands to fill available height */}
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-6 md:gap-8 min-h-0">
          ...
          <div ref={leftColRef} className="flex flex-col justify-between gap-2.5 sm:gap-4 md:gap-6 h-full">
            ...
            <div className="p-3.5 sm:p-6 md:p-8 rounded-xl md:rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between flex-1">
              <div>
                ...
                <h3 className="text-sm sm:text-lg md:text-2xl font-bold text-slate-900 mb-1">
                  Byzid Apparels (Pvt) Ltd.
                </h3>
                <p className="text-xs sm:text-sm md:text-base text-slate-600 leading-relaxed mb-2">
              ...
              <div className="pt-2 border-t border-slate-100">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 sm:px-5 py-1.5 sm:py-2.5 rounded-lg bg-slate-900 text-white text-xs sm:text-sm font-bold shadow-sm"
                >
            ...
            <div className="p-3.5 sm:p-5 md:p-7 rounded-xl md:rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between flex-1">
              <div className="flex items-center gap-1.5 text-[10px] sm:text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">
          ...
          <div ref={rightColRef} className="flex flex-col justify-between gap-2.5 sm:gap-4 md:gap-6 h-full">
            {/* Key Executives */}
            <div className="p-3.5 sm:p-6 md:p-8 rounded-xl md:rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between flex-1">
              <div className="flex items-center gap-1.5 text-[10px] sm:text-xs font-bold text-[#69b23f] uppercase tracking-wider mb-2">
                <UserCheck className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                <span>Executive Contacts</span>
              </div>

              {/* MD */}
              <div className="p-2.5 sm:p-3.5 rounded-lg bg-slate-50 border border-slate-100 mb-2 flex items-center justify-between">
                <div>
                  <div className="text-xs sm:text-base font-bold text-slate-900 font-sans">
                    Mr. Abdur Rahaman
                  </div>
                ...
                <button
                  ...
                  className="p-2 sm:p-2.5 rounded-lg bg-white border border-slate-200 text-slate-600 hover:text-[#69b23f] shadow-2xs"
                  title="Copy Email"
                >
                  {copiedEmail === "md" ? (
              ...
              {/* Operations Director */}
              <div className="p-2.5 sm:p-3.5 rounded-lg bg-slate-50 border border-slate-100 flex items-center justify-between">
                <div>
                  <div className="text-xs sm:text-base font-bold text-slate-900 font-sans">
                    Mrs. Susan Rebeiro
                  </div>
            ...
            {/* Banking */}
            <div className="p-3.5 sm:p-5 md:p-7 rounded-xl md:rounded-2xl bg-slate-950 text-white shadow-md border border-slate-800 flex flex-col justify-between flex-1">
